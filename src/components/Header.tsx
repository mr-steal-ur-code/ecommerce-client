	...
	return (
		<header className="bg-primary text-white">
			<div className="max-w-7xl mx-auto p-4 flex items-center justify-between">
				...
				<nav
					className={`${
						isMenuOpen ? "max-h-10" : "max-h-0 md:max-h-10"
					} transition-[max-height] duration-300 overflow-hidden md:flex md:items-center space-y-4 md:space-y-0 md:space-x-4 absolute md:static top-16 md:top-auto left-0 w-full md:w-auto bg-primary md:bg-transparent z-10 ease-in-out`}
				>
